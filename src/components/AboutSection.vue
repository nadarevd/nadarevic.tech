<template>
  <!-- PC Version -->
  <div id="about" class="">
    <div v-motion-fade  class="container mx-auto px-24 pb-24 hidden gridsm:block">
      <div class="flex md:space-x-4 justify-center">
        ...
        <div class="flex items-start flex-col space-y-4">
          ...
          <div class="flex md:space-x-4 h-32 w-full items-center">
        ...
        <div class="flex flex-col flex-none space-y-4 xl:max-w-72 max-w-64">
          <div class="rounded-3xl bg-[#eae8ea] p-6">
            <div class="flex flex-col">
              <h1 class=" bg-clip-text bg-gradient-to-b from-[#5ac8fa]  to-[#2e307d] font-extrabold text-transparent text-3xl">Business</h1>
              <p class="font-bold uppercase">Major</p>
            </div>
          </div>
          <div class="rounded-3xl bg-[#eae8ea] p-6 ">
            <div class="flex flex-col">
              <p class="font-bold uppercase">With</p>
              <h1 class=" bg-clip-text bg-gradient-to-b from-[#5ac8fa]  to-[#2e307d] font-extrabold text-transparent text-3xl">Comp Sci.</h1>
              <p class="font-bold uppercase">Background</p>
            </div>
          </div>
          <div class="flex space-x-4">
            <div class="rounded-3xl bg-[#eae8ea] p-6 xl:w-36 w-32 flex-1">
              <div class="flex flex-col">
                <h1 class=" bg-clip-text bg-gradient-to-b from-[#5ac8fa]  to-[#2e307d] font-extrabold text-transparent text-5xl">15</h1>
                <p class="font-bold uppercase">Tools</p>
              </div>
            </div>
            <div class="rounded-3xl bg-[#eae8ea] p-6 xl:w-36 w-32 flex-1">
              <div class="flex flex-col">
                <h1 class=" bg-clip-text bg-gradient-to-b from-[#5ac8fa]  to-[#2e307d] font-extrabold text-transparent text-5xl">3+</h1>
                <p class="font-bold uppercase">Yrs. Of</p>
                <p class="font-bold uppercase">Exp.</p>
              </div>
            </div>
          </div>
          <div class="rounded-3xl bg-[#eae8ea] p-6 flex flex-col overflow-hidden h-64 grow">
  ...
  <!-- Mobile Version -->
  <div id="about">
    <div class="sm:container mx-auto gridsm:hidden block pb-24">
