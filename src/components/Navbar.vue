            ...
            <div class="w-full flex items-center justify-center">
                <div class="flex font-light items-center justify-center ">
                    ...
                    <div class="hidden lg:flex items-center">
                        ...
                        <a href="../../public/assets/files/Resume 2022.pdf" download="Resume" target="_blank" class="text-xs underline text-[#d5d5d6] font-bold hover:text-indigo-50 mx-6">Resume</a>
